...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en">
	...
	function getDynamicConfiguration(){
		...
		$conf['globalresourceloader']['ds-names'] = 'index_category,index_priority,index_status,member_details,index_anonymous';
		$conf['globalresourceloader']['ds-pages'] = '75,76';
		$conf['dump_db']['last_sync'] = '2011-12-06T17:05:54+01:00';
		$conf['members']['cookie-prefix'] = 'sym-members';
		$conf['members']['section'] = '15';
